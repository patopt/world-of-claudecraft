...
export const CLASSES: Record<PlayerClass, ClassDef> = {
  ...
  necromancer: {
    id: 'necromancer',
    name: 'Necromancer',
    baseStats: { str: 10, agi: 11, sta: 16, int: 22, spi: 20, armor: 22 },
    statsPerLevel: { str: 0, agi: 0, sta: 1, int: 3, spi: 2, armor: 4 },
    baseHp: 42,
    hpPerLevel: 13,
    baseMana: 105,
    ...
    startChest: 'apprentice_robe',
    abilities: [
      'bone_bolt', 'bone_armor', 'grave_rot', 'dark_mending', 'chill_of_the_grave',
      'grip_of_the_dead', 'wave_of_decay', 'soul_leech', 'unholy_might', 'deathbloom',
    ],
    color: 0x71d0a4,
    crest: '☠',
  },
  monk: {
    id: 'monk',
    name: 'Monk',
    baseStats: { str: 18, agi: 23, sta: 19, int: 12, spi: 14, armor: 42 },
    statsPerLevel: { str: 1, agi: 3, sta: 2, int: 0, spi: 1, armor: 8 },
    baseHp: 47,
    hpPerLevel: 15,
    baseMana: 100, // energy cap
    manaPerLevel: 0,
    ...
    startChest: 'footpad_jerkin',
    abilities: [
      'tiger_palm', 'rising_kick', 'iron_palm', 'fortifying_brew', 'leg_sweep',
      'way_of_the_wind', 'spinning_crane_kick', 'mending_breath', 'inner_stillness', 'touch_of_death',
    ],
    color: 0x00d49c,
    crest: '☯',
  },
...
export const ABILITIES: Record<string, AbilityDef> = {
  ...
  // ====================== NECROMANCER ======================
  bone_bolt: {
    id: 'bone_bolt', name: 'Bone Bolt', class: 'necromancer', learnLevel: 1,
    cost: 24, castTime: 1.7, cooldown: 0, range: 30, school: 'shadow',
    requiresTarget: true,
    effects: [{ type: 'directDamage', min: 13, max: 18 }],
    ranks: [
      { rank: 2, level: 8, cost: 36, castTime: 2.2, effects: [{ type: 'directDamage', min: 24, max: 31 }] },
      { rank: 3, level: 14, cost: 54, castTime: 2.6, effects: [{ type: 'directDamage', min: 41, max: 52 }] },
      { rank: 4, level: 20, cost: 78, castTime: 3.0, effects: [{ type: 'directDamage', min: 66, max: 82 }] },
    ],
    icon: 'BB', iconColor: '#d5f5e3',
    description: 'Hurls a shard of sharpened bone at the enemy for $d Shadow damage.',
  },
  bone_armor: {
    id: 'bone_armor', name: 'Bone Armor', class: 'necromancer', learnLevel: 1,
    cost: 25, castTime: 0, cooldown: 8, range: 0, school: 'shadow',
    requiresTarget: false,
    effects: [{ type: 'absorb', amount: 30, duration: 30 }],
    ranks: [
      { rank: 2, level: 10, cost: 45, effects: [{ type: 'absorb', amount: 65, duration: 30 }] },
      { rank: 3, level: 18, cost: 70, effects: [{ type: 'absorb', amount: 110, duration: 30 }] },
    ],
    icon: 'BO', iconColor: '#fdfefe',
    description: 'Shields of whirling bone absorb 30 damage for 30 sec.',
  },
  grave_rot: {
    id: 'grave_rot', name: 'Grave Rot', class: 'necromancer', learnLevel: 4,
    cost: 30, castTime: 0, cooldown: 0, range: 30, school: 'shadow',
    requiresTarget: true,
    effects: [{ type: 'dot', total: 28, duration: 21, interval: 3 }],
    ranks: [
      { rank: 2, level: 12, cost: 48, effects: [{ type: 'dot', total: 60, duration: 21, interval: 3 }] },
      { rank: 3, level: 18, cost: 68, effects: [{ type: 'dot', total: 96, duration: 21, interval: 3 }] },
    ],
    icon: 'GR', iconColor: '#52be80',
    description: 'The rot of the grave consumes the target: $d Shadow damage over 21 sec.',
  },
  dark_mending: {
    id: 'dark_mending', name: 'Dark Mending', class: 'necromancer', learnLevel: 6,
    cost: 30, castTime: 2.5, cooldown: 0, range: 30, school: 'shadow',
    requiresTarget: true, targetType: 'friendly',
    effects: [{ type: 'heal', min: 18, max: 26 }],
    ranks: [
      { rank: 2, level: 12, cost: 50, castTime: 3.0, effects: [{ type: 'heal', min: 38, max: 50 }] },
      { rank: 3, level: 18, cost: 72, castTime: 3.0, effects: [{ type: 'heal', min: 62, max: 78 }] },
    ],
    icon: 'DM', iconColor: '#a9dfbf',
    description: 'Knits flesh with stolen vitality, healing a friendly target for $d.',
  },
  chill_of_the_grave: {
    id: 'chill_of_the_grave', name: 'Chill of the Grave', class: 'necromancer', learnLevel: 8,
    cost: 28, castTime: 1.8, cooldown: 0, range: 30, school: 'frost',
    requiresTarget: true,
    effects: [{ type: 'directDamage', min: 16, max: 21 }, { type: 'slow', mult: 0.6, duration: 8 }],
    ranks: [
      { rank: 2, level: 14, cost: 44, effects: [{ type: 'directDamage', min: 31, max: 39 }, { type: 'slow', mult: 0.6, duration: 8 }] },
      { rank: 3, level: 20, cost: 62, effects: [{ type: 'directDamage', min: 48, max: 59 }, { type: 'slow', mult: 0.6, duration: 8 }] },
    ],
    icon: 'CG', iconColor: '#aed6f1',
    description: 'Grave-cold seizes the target for $d Frost damage, slowing it by 40% for 8 sec.',
  },
  grip_of_the_dead: {
    id: 'grip_of_the_dead', name: 'Grip of the Dead', class: 'necromancer', learnLevel: 10,
    cost: 35, castTime: 0, cooldown: 20, range: 25, school: 'shadow',
    requiresTarget: true,
    effects: [{ type: 'root', duration: 6 }],
    icon: 'GD', iconColor: '#7dcea0',
    description: 'Skeletal hands burst from the earth, rooting the target in place for up to 6 sec.',
  },
  wave_of_decay: {
    id: 'wave_of_decay', name: 'Wave of Decay', class: 'necromancer', learnLevel: 12,
    cost: 45, castTime: 0, cooldown: 0, range: 0, school: 'shadow',
    requiresTarget: false,
    effects: [{ type: 'aoeDamage', min: 13, max: 17, radius: 8 }],
    ranks: [
      { rank: 2, level: 18, cost: 70, effects: [{ type: 'aoeDamage', min: 25, max: 32, radius: 8 }] },
    ],
    icon: 'WD', iconColor: '#239b56',
    description: 'A wave of entropy rots all nearby enemies for $d Shadow damage.',
  },
  soul_leech: {
    id: 'soul_leech', name: 'Soul Leech', class: 'necromancer', learnLevel: 14,
    cost: 40, castTime: 0, channel: { duration: 5, ticks: 5 }, cooldown: 0, range: 20, school: 'shadow',
    requiresTarget: true,
    effects: [{ type: 'drainTick', min: 9, max: 9, healFrac: 1 }],
    ranks: [
      { rank: 2, level: 20, cost: 60, effects: [{ type: 'drainTick', min: 15, max: 15, healFrac: 1 }] },
    ],
    icon: 'SL', iconColor: '#48c9b0',
    description: 'Leeches the target\'s soul, transferring 9 health to you each second for 5 sec.',
  },
  unholy_might: {
    id: 'unholy_might', name: 'Unholy Might', class: 'necromancer', learnLevel: 16,
    cost: 40, castTime: 0, cooldown: 0, range: 0, school: 'shadow',
    requiresTarget: false,
    effects: [{ type: 'selfBuff', kind: 'buff_int', value: 12, duration: 1800 }],
    icon: 'UM', iconColor: '#1d8348',
    description: 'Death\'s knowledge sharpens your mind, increasing Intellect by 12 for 30 min.',
  },
  deathbloom: {
    id: 'deathbloom', name: 'Deathbloom', class: 'necromancer', learnLevel: 20,
    cost: 68, castTime: 0, cooldown: 15, range: 25, school: 'shadow',
    requiresTarget: true,
    effects: [{ type: 'directDamage', min: 55, max: 65 }],
    icon: 'DB', iconColor: '#117a65',
    description: 'Instantly blooms necrotic energy inside the target for $d Shadow damage.',
  },

  // ====================== MONK ======================
  tiger_palm: {
    id: 'tiger_palm', name: 'Tiger Palm', class: 'monk', learnLevel: 1,
    cost: 45, castTime: 0, cooldown: 0, range: 0, school: 'physical',
    requiresTarget: true, awardsCombo: 1,
    effects: [{ type: 'weaponStrike', bonus: 3 }],
    ranks: [
    ...
    icon: 'TP', iconColor: '#f5cba7',
    description: 'An open-palm strike for weapon damage plus $d. Awards 1 combo point.',
  },
  rising_kick: {
    id: 'rising_kick', name: 'Rising Kick', class: 'monk', learnLevel: 1,
    cost: 35, castTime: 0, cooldown: 0, range: 0, school: 'physical',
    requiresTarget: true, spendsCombo: true,
    effects: [{ type: 'finisherDamage', base: 4, perCombo: 7, variance: 4 }],
    ranks: [
    ...
    icon: 'RK', iconColor: '#dc7633',
    description: 'A rising finishing kick that causes damage per combo point.',
  },
  iron_palm: {
    id: 'iron_palm', name: 'Iron Palm', class: 'monk', learnLevel: 4,
    cost: 60, castTime: 0, cooldown: 0, range: 0, school: 'physical',
    requiresTarget: true, awardsCombo: 1,
    effects: [{ type: 'weaponStrike', bonus: 11, weaponMult: 1.5 }],
    ranks: [
      { rank: 2, level: 12, cost: 60, effects: [{ type: 'weaponStrike', bonus: 20, weaponMult: 1.5 }] },
      { rank: 3, level: 18, cost: 60, effects: [{ type: 'weaponStrike', bonus: 32, weaponMult: 1.5 }] },
    ],
    icon: 'IP', iconColor: '#aab7b8',
    description: 'A focused blow for 150% weapon damage plus $d. Awards 1 combo point.',
  },
  fortifying_brew: {
    id: 'fortifying_brew', name: 'Fortifying Brew', class: 'monk', learnLevel: 6,
    cost: 0, castTime: 0, cooldown: 120, range: 0, school: 'physical',
    requiresTarget: false, offGcd: true,
    effects: [{ type: 'absorb', amount: 45, duration: 20 }],
    ranks: [
      { rank: 2, level: 14, cost: 0, effects: [{ type: 'absorb', amount: 90, duration: 20 }] },
      { rank: 3, level: 20, cost: 0, effects: [{ type: 'absorb', amount: 140, duration: 20 }] },
    ],
    icon: 'FB', iconColor: '#d4ac0d',
    description: 'You steady yourself with a draught of fortifying brew, absorbing 45 damage for 20 sec.',
  },
  leg_sweep: {
    id: 'leg_sweep', name: 'Leg Sweep', class: 'monk', learnLevel: 8,
    cost: 45, castTime: 0, cooldown: 20, range: 0, school: 'physical',
    requiresTarget: true,
    effects: [{ type: 'directDamage', min: 8, max: 10 }, { type: 'stun', duration: 2 }],
    ranks: [{
      rank: 2, level: 16, cost: 45,
      effects: [{ type: 'directDamage', min: 18, max: 22 }, { type: 'stun', duration: 2 }],
    }],
    icon: 'LS', iconColor: '#ca6f1e',
    description: 'Sweeps the target\'s legs, dealing $d damage and stunning it for 2 sec.',
  },
  way_of_the_wind: {
    id: 'way_of_the_wind', name: 'Way of the Wind', class: 'monk', learnLevel: 10,
    cost: 0, castTime: 0, cooldown: 300, range: 0, school: 'physical',
    requiresTarget: false, offGcd: true,
    effects: [{ type: 'selfBuff', kind: 'buff_speed', value: 1.7, duration: 15 }],
    icon: 'WW', iconColor: '#a3e4d7',
    description: 'You move like the mountain wind, increasing movement speed by 70% for 15 sec.',
  },
  spinning_crane_kick: {
    id: 'spinning_crane_kick', name: 'Spinning Crane Kick', class: 'monk', learnLevel: 12,
    cost: 50, castTime: 0, cooldown: 0, range: 0, school: 'physical',
    requiresTarget: false,
    effects: [{ type: 'aoeDamage', min: 13, max: 16, radius: 8 }],
    ranks: [
      { rank: 2, level: 18, cost: 50, effects: [{ type: 'aoeDamage', min: 24, max: 30, radius: 8 }] },
    ],
    icon: 'CK', iconColor: '#76d7c4',
    description: 'You spin like the crane, striking all nearby enemies for $d damage.',
  },
  mending_breath: {
    id: 'mending_breath', name: 'Mending Breath', class: 'monk', learnLevel: 14,
    cost: 40, castTime: 0, cooldown: 30, range: 30, school: 'nature',
    requiresTarget: true, targetType: 'friendly',
    effects: [{ type: 'heal', min: 34, max: 44 }],
    ranks: [
      { rank: 2, level: 20, cost: 55, effects: [{ type: 'heal', min: 58, max: 72 }] },
    ],
    icon: 'MB', iconColor: '#abebc6',
    description: 'A measured breath restores $d health to a friendly target.',
  },
  inner_stillness: {
    id: 'inner_stillness', name: 'Inner Stillness', class: 'monk', learnLevel: 16,
    cost: 0, castTime: 0, cooldown: 300, range: 0, school: 'physical',
    requiresTarget: false, offGcd: true,
    effects: [{ type: 'selfBuff', kind: 'buff_dodge', value: 0.5, duration: 15 }],
    icon: 'IS', iconColor: '#d6eaf8',
    description: 'You empty your mind and read every blow, increasing dodge chance by 50% for 15 sec.',
  },
  touch_of_death: {
    id: 'touch_of_death', name: 'Touch of Death', class: 'monk', learnLevel: 20,
    cost: 65, castTime: 0, cooldown: 20, range: 0, school: 'physical',
    requiresTarget: true, awardsCombo: 1,
    effects: [{ type: 'weaponStrike', bonus: 40, weaponMult: 1.8 }],
    icon: 'TD', iconColor: '#196f3d',
    description: 'Strikes a fatal pressure point for 180% weapon damage plus $d. Awards 1 combo point.',
  },
};
